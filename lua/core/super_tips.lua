-- 核心家族lua,超级提示,表情\化学式\方程式\简码等等直接上屏,不占用候选位置
...
tips.default_preset = core.get_filename_with_fallback("lua/data/tips_show.txt")
...
function tips.init(config)
    ...
    if needs_rebuild then
        ...
        -- 更新元数据
        tips_db:meta_update(META_KEY.version, core.version)
...
function P.func(key, env)
    ...
    if not P.tips_key 
        ...
        or core.is_function_mode_active(context)
